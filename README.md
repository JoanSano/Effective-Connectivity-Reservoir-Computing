...
PROVISIONAL README DOCUMENTATION. IN DEVELOPMENT. THIS IS JUST TO GIVE AN OVERVIEW OF HOW TO EXECUTE THE CODE.
...
fmri [-h] [--dir DIR] [--subjects [SUBJECTS ...]] [--rois ROIS [ROIS ...]] [--split SPLIT] [--skip SKIP]
...
options:
  ...
  --subjects [SUBJECTS ...] List of subjects to process. Default is all. Type -1 for all.

  --rois ROIS [ROIS ...]    Space separated list of ROIs to analyse. Set to -1 for whole brain analysis. Default is -1
