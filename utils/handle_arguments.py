...
def optional_arguments(main_parser):
    ...
    main_parser.add_argument('--min_lag', type=int, default=-30, help="Minimum lag to test")
    main_parser.add_argument('--max_lag', type=int, default=31, help="Maximum lag test")
